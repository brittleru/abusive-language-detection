...
MODEL_FILE_NAME = "bertweet_large_founta"
...
def encode_tweet(tweet: str, bertweet_tokenizer: PreTrainedTokenizerBase):
    return bertweet_tokenizer.encode_plus(
        # tweet,
        # process_data(tweet),
        process_data(tweet, do_stemming=False, do_lemmas=True, do_lowercase=True),
...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained(BERTWEET_TYPE, normalization=True, do_lower_case=True)
